            ...
            <div className="legal">
                <div className="banner">
                    <header className="banner__title">
                        <h1 className="heading-1">Cookies policy</h1>
                    </header>
                </div>

                <div className="detail">
                    <div className="description">
                    <h2>Cookies Policy of <span className="website_url">cooking.tommasodemarco.com</span></h2>

<p>This website, <span className="website_url">cooking.tommasodemarco.com</span> (the "Website"), is operated by <span className="website_name">CooKing</span>. This Cookies Policy was created by <a href="https://www.cookiespolicytemplate.com">Cookies Policy Template</a> for <span className="website_url">cooking.tommasodemarco.com</span></p>

<h3>What are cookies?</h3>

<p>Cookies are a small text files that are stored in your web browser that allows <span className="website_name">CooKing</span> or a third party to recognize you. Cookies can be used to collect, store and share bits of information about your activities across websites, including on <span className="website_name">CooKing</span> website. Information regarding cookies from this Cookies Policy are from <a href="https://www.generateprivacypolicy.com/">the Privacy Policy Generator</a>.</p>
...
<p><span className="website_name">CooKing</span> uses both session cookies and persistent cookies.</p>
...
<h3>How do third parties use cookies on the <span className="website_name">CooKing</span> Website?</h3>

<p>Third party companies like analytics companies and ad networks generally use cookies to collect user information on an anonymous basis. They may use that information to build a profile of your activities on the <span className="website_name">CooKing</span> Website and other websites that you've visited.</p>
...
<p>To learn more about cookies, please read <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies"</a>.</p>
                    </div>
                </div>
            </div>
        </main>
