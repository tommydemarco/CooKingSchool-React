        ...
        <main className="main">
            <div className="legal">
                ...
                <div className="detail">
                    ...
                    <h2>Privacy Policy of <span className="website_url">cooking.tommasodemarco.com</span></h2>

<p>At <span className="website_name">CooKing</span>, we collect and manage user data according to the following Privacy Policy.</p>
...
<p>We only use your personal information to provide you the <span className="website_name">CooKing</span> services or to communicate with you about the Website or the services.</p>
